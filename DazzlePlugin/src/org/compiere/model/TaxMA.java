 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: Tax.java,v 1.1 2013-02-22 14:26:21 maugustine Exp $
 *
				...
				)
			{
				...
				for (int j = 0; j < postals.length; j++)
				{
					...
					if (postal.isActive()
						...
						&& postal.getPostal() != null  // Martin added because of possible null pointer error
						&& (lFrom.getPostal() != null && postal.getPostal().startsWith(lFrom.getPostal()))
						//	Postal To is optional
						&& (postal.getPostal_To() == null
							|| (lTo.getPostal() != null && // Martin added because of possible null pointer error
