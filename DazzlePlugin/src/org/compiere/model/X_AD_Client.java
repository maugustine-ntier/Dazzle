...
// F
	...
	/** Set Print Header.
		@param ZZ_Header Print Header	  */
	public void setZZ_Header (String ZZ_Header)
	{
		set_Value (COLUMNNAME_ZZ_Header, ZZ_Header);
	}

	/** Get Print Header.
		@return Print Header	  */
	public String getZZ_Header () 
	{
		return (String)get_Value(COLUMNNAME_ZZ_Header);
	}

	/** Set Invoice Terms.
		@param ZZ_Invoice_Footer Invoice Terms	  */
	public void setZZ_Invoice_Footer (String ZZ_Invoice_Footer)
	{
		set_Value (COLUMNNAME_ZZ_Invoice_Footer, ZZ_Invoice_Footer);
	}

	/** Get Invoice Terms.
		@return Invoice Terms	  */
	public String getZZ_Invoice_Footer () 
	{
		return (String)get_Value(COLUMNNAME_ZZ_Invoice_Footer);
	}

	/** Set Quote Terms.
		@param ZZ_Quote_Footer Quote Terms	  */
	public void setZZ_Quote_Footer (String ZZ_Quote_Footer)
	{
		set_Value (COLUMNNAME_ZZ_Quote_Footer, ZZ_Quote_Footer);
	}

	/** Get Quote Terms.
		@return Quote Terms	  */
	public String getZZ_Quote_Footer () 
	{
		return (String)get_Value(COLUMNNAME_ZZ_Quote_Footer);
	}
}