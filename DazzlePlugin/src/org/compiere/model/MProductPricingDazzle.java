 ...
 */
public class MProductPricingDazzle
{
	 ...
	 */
	public MProductPricingDazzle (int M_Product_ID, int C_BPartner_ID,
	...
	public BigDecimal getDiscount()
	{
		...
		// if (m_PriceList.intValue() != 0)  // This is wrong  , what about values that are less than 1.
		if (m_PriceList.compareTo(Env.ZERO) != 0) {  // Martin changed above to this.   05/08/2013
