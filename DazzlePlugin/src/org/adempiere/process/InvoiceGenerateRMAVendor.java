 ...
 */
public class InvoiceGenerateRMAVendor extends SvrProcess
{
    /** Manual Selection        */
    ...
    protected void prepare()
    {
        ...
        for (int i = 0; i < para.length; i++)
        {
            ...
            if (para[i].getParameter() == null)
            	...
            	m_dateinvoiced = (Timestamp)para[i].getParameter();  // Martin added 01102013
            else
    ...
    private MInvoice createInvoice(MRMA rma)
    {
        ...
        if (m_dateinvoiced != null) {  // Martin added 01102013
