 ...
 */
public class InOutGenerateRMAVendor extends SvrProcess
{
    /** Manual Selection        */
    ...
    protected void prepare()
    {
        ...
        for (int i = 0; i < para.length; i++)
        {
            ...
            if (para[i].getParameter() == null)
            	...
            	m_movementDate = (Timestamp)para[i].getParameter();  // Martin added 01102013
            else
    ...
    private MInOut createShipment(MRMA rma)
    {
        ...
        if (m_movementDate != null) {
        	shipment.setMovementDate(m_movementDate); // Martin added 01102013
        }
