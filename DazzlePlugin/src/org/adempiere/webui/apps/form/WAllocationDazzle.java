 ...
 * 
 * Contributor NCG 2014/09/27
 * Original class: WAllocation
 * Modified for #20140926_1000192_PaymentAllocationNotCopiedAppliedAmount
 * 
 * Contributor : Fabian Aguilar - OFBConsulting - Multiallocation
 */
public class WAllocationDazzle extends Allocation
	implements IFormController, EventListener<Event>, WTableModelListener, ValueChangeListener
{
	...
	// nTier NCG 2014/04/30 #RQ100009: Payment Allocation: Allow Charges Tax
//	private Label taxIncludedLabel = new Label();
	private Checkbox isTaxIncludedCheckbox = new Checkbox();
	...
	private void zkInit() throws Exception
	{
		...
		// nTier NCG 2014/04/30 #RQ100009: Payment Allocation: Allow Charges Tax
//		taxIncludedLabel.setText("Price Includes Tax");
		...
		// nTier NCG 2014/04/30 #RQ100009: Payment Allocation: Allow Charges Tax
//		row.appendCellChild(taxIncludedLabel.rightAlign());
//		taxIncluded.getComponent().setHflex("true");
		row.appendCellChild(isTaxIncludedCheckbox);
		isTaxIncludedCheckbox.setSelected(false);
		isTaxIncludedCheckbox.setText(Msg.getMsg(Env.getCtx(), "Price Includes Tax", true));
		isTaxIncludedCheckbox.setTooltiptext(Msg.getMsg(Env.getCtx(), "Price Includes Tax", false));
	...
	public void onEvent(Event e)
	{
		...
		{
			//TODO: nTier NCG 2014/04/30 #RQ100009: Payment Allocation: Allow Charges Tax
	 ...
	 */
	public String test(IMiniTable payment, boolean isMultiCurrency)
	{
		log.config("");
...
//			+ Msg.getMsg(Env.getCtx(), "Sum") + "  " + format.format(totalPay) + " ";
	...
	public void valueChange (ValueChangeEvent e)
	{
		...
		else if (name.equals("C_Charge_ID") )
		{
			...
			//TODO: nTier NCG 2014/04/30 #RQ100009: Payment Allocation: Allow Charges Tax (Copy istaxincluded from charge to cb)
			// nTier NCG 2014/04/30 #RQ100009: Payment Allocation: Allow Charges Tax
			MCharge charge = new MCharge(Env.getCtx(), m_C_Charge_ID, null);
			isTaxIncludedCheckbox.setSelected(charge.isTaxIncluded());
	...
	{
		//TODO: nTier NCG 2014/04/30 #RQ100009: Payment Allocation: Allow Charges Tax (saveData)
		//m_isTaxIncluded = isTaxIncludedCheckbox.isChecked();  Martin commented 20/01/2021
		if (m_AD_Org_ID > 0)
