...
public class ListboxFactoryMA {
	 ...
	 * @return WListbox
	 */
	public static WListboxMA newDataTable() {
		WListboxMA dataTable = new WListboxMA();
		dataTable.setWidth("100%");
		dataTable.setHeight("100%");
		dataTable.setSizedByContent(false);
		// dataTable.setVflex(true);  Martin 21/01/2021  migration to idempiere 8
