 ...
 */
public class WListboxMA extends Listbox implements IMiniTable, TableValueChangeListener, WTableModelListener
{
	/**
	 *
	 */
	...
	{
		super();
		WListItemRendererMA rowRenderer = new WListItemRendererMA();
...
//		 instantiate our custom row renderer
	    //rowRenderer = new WListItemRenderDazzle(columnNames, columnWidths);   // Martin changed
		WListItemRendererMA rowRenderer = null;
		if (columnNames != null && columnNames.size() > 0)
		{
	    	//	 instantiate our custom row renderer
			//rowRenderer = new WListItemRenderDazzle(columnNames, columnWidths);
			// Martin changed
			rowRenderer = new WListItemRenderDazzle(columnNames, columnWidths);
	...
	private void initialiseHeader()
	{
	    ...
	    // render list head
	    if (this.getItemRenderer() instanceof WListItemRendererMA)
	    {
	    	((WListItemRendererMA)this.getItemRenderer()).renderListHead(head);
	    }
	    else
	    {
	...
	{
		WListItemRendererMA renderer = (WListItemRendererMA)getItemRenderer();
